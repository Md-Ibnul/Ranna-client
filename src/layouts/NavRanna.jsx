        ...
        <div className="navbar-end">
          {user ? (
            <button
              ...
              className="me-4 btn btn-sm text-white btn-error"
            >
              Log Out
            </button>
          ) : (
            <Link className="btn btn-sm text-white btn-secondaty" to="/login">
              Login
            </Link>
          )}
          {user && (
            <div
              className="rounded-full w-12 tooltip tooltip-bottom"
